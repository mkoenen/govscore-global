var app = {
    ...
    document.addEventListener("deviceready", this.showResultsButtons, false);
    document.addEventListener("deviceready", this.onOnline, true);
    },
   ...
   /* Events -----------------------------------------*/
    ...
    messageAfterSaveLocal: function() {
    ...
    checkConnection: function(whichfunction) {
    ...
    getinputs: function(answerset,num1,num2,prefix){
        var i, key, value;
        //loop through the entries, grab value and store in array
        for(i=num1; i<=num2; i++) {
            key = "'" + prefix + i +"'";
    ...
    gsSaved: "false", ag1Saved: "false", ag2Saved: "false", ag3Saved: "false", ag4Saved: "false", ag5Saved: "false",

    //save the json data array to the server via ajax call
    saveToServer: function (address,dataset,datasaved){
          $.ajax({
          type       : "GET",
          url        : address,
          crossDomain: true,
